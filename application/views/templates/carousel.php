 ...
 <!-- #region Jssor Slider Begin -->
    ...
    <script src="<?php echo base_url(); ?>assets/js/jssor.slider-26.1.5.min.js" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:auto;height:380px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <div>
                ...
                <div data-u="caption" data-t="0" style="position:absolute;top:320px;left:30px;width:350px;height:30px;z-index:0;background-color:rgba(255,188,5,0.8);font-size:20px;color:#ffffff;line-height:30px;text-align:center;"> making the best of your translation documents at a very affordable price. why wait again? get in touch with us</div>
            </div>
            <div data-p="170.00">
            ...
            <div>
                ...
                <div data-u="caption" data-t="2" style="position:absolute;top:30px;left:-380px;width:350px;height:30px;z-index:0;background-color:rgba(255,188,5,0.8);font-size:20px;color:#ffffff;line-height:30px;text-align:center;">finger catchable right to left</div>
            </div>
            <div>
                <img data-u="image" src="<?php echo base_url(); ?>assets/img/004.jpg" />
            ...
            <div>
                <img data-u="image" src="<?php echo base_url(); ?>assets/img/005.jpg" />
            ...
            <div>
                <img data-u="image" src="<?php echo base_url(); ?>assets/img/006.jpg" />
            ...
            <div>
                <img data-u="image" src="<?php echo base_url(); ?>assets/img/007.jpg" />
            ...
            <div data-b="0">
                <img data-u="image" src="<?php echo base_url(); ?>assets/img/008.jpg" />
            ...
            <div data-p="170.00">
                <img data-u="image" src="<?php echo base_url(); ?>assets/img/009.jpg" />
            ...
            <div data-p="170.00">
                <img data-u="image" src="<?php echo base_url(); ?>assets/img/010.jpg" />
                <div data-u="caption" data-t="10" data-3d="1" style="position:absolute;top:25px;left:100px;width:250px;height:250px;z-index:0;background-color:rgba(40,177,255,0.6);">
                    <div style="margin: 15px; font-size: 20px;">
                        ...
                        <img src="<?php echo base_url(); ?>assets/img/icon_chrome.png" /> here.
